...
aplicación (EVACYL), el autor, su contacto, la licencia de uso, y la
...
class VentanaBienvenida(VentanaConFondo):
    ...
    def __init__(self):
        ...
        panel.setStyleSheet(
            ...
            f"  border-top: 6px solid {PALETA['verde_medio']};"
            f"}}"
        )
        ...
        subtitulo.setStyleSheet(f"color: {PALETA['verde_medio']}; font-size: 15px; font-style: italic;")
        layout.addWidget(subtitulo)

        subtitulo2 = QLabel("Evaluación por competencias para Primaria, Secundaria y Bachillerato")
        ...
        tarjeta_autoria.setStyleSheet(
            f"QFrame {{ background-color: {PALETA['verde_muy_claro']}; "
        ...
        etiqueta_autor.setStyleSheet(f"font-size: 16px; font-weight: 600; color: {PALETA['verde_muy_oscuro']};")
        ...
        etiqueta_contacto.setStyleSheet(f"font-size: 14px; color: {PALETA['verde_medio']};")
        ...
        # -- tarjeta de licencia (con un toque de color de acento) --
        tarjeta_licencia = QFrame()
        tarjeta_licencia.setStyleSheet(
            f"QFrame {{ background-color: {PALETA['acento_calido_claro']}; "
            f"border-radius: 12px; border-left: 4px solid {PALETA['acento_calido']}; }}"
        )
        ...
        etiqueta_licencia.setStyleSheet(f"color: {PALETA['verde_muy_oscuro']}; font-size: 13px;")
        ...
        # -- tarjeta de colaboración del IES Virgen de la Calle --
