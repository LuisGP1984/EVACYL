...
subcarpeta con su curso.db). Esta carpeta solo se pide una vez; a partir
de ahí, la app la recuerda y pasa directamente a elegir/crear el curso.
"""
...
class VentanaCarpetaDocente(VentanaConFondo):
    ...
    def __init__(self):
        ...
        explicacion = QLabel(
            ...
            "ejemplo, «2025-2026»), cada una con sus propios datos. Solo se pregunta una "
            "vez: la próxima vez que abras la aplicación, se recordará."
        )
        explicacion.setWordWrap(True)
        explicacion.setStyleSheet("color: #5B6B82;")
