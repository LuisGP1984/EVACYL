...
#
# Archivo de configuración de PyInstaller para "EVACYL". Incluye
# automáticamente las carpetas recursos/ (imagen de fondo, logo, icono)
# y datos_curriculares/ (currículo oficial) dentro del ejecutable, para
# que funcione igual en cualquier ordenador sin necesitar esos archivos
# sueltos al lado.
#
# Uso (desde la carpeta del proyecto, en Windows, con el entorno ya
# preparado según el README de empaquetado):
#
#   pyinstaller empaquetado.spec
#
# El resultado queda en dist\EVACYL\
